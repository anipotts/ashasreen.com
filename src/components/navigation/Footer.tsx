            ...
            <ul className="space-y-2">
              {FOOTER_LINKS.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm text-[var(--color-neutral-medium)] hover:text-[var(--color-primary)] transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="flex space-x-4">
              {SOCIAL_LINKS.map((social) => (
                <a
                  ...
                  className={`p-2 rounded-full bg-[var(--color-neutral-light)]/10 ${social.hoverColor} transition-colors`}
